...
function MetadataRow({ label, value, mono, isLoading }: MetadataRowProps) {
  return (
        ...
        <div>
          <Card className="h-fit">
            ...
            <CardContent className="space-y-4">
              <MetadataRow label="数据集合 ID" isLoading />
              <MetadataRow label="数据总数" isLoading />
              <MetadataRow label="创建时间" isLoading />
              <MetadataRow label="更新时间" isLoading />
            </CardContent>
          </Card>
        </div>
      </div>
      ...
      <aside className="space-y-4">
        <Card className="h-fit">
          ...
          <CardContent className="space-y-4">
            ...
            <MetadataRow
              label="数据总数"
              value={collection?.dataCount ?? "—"}
            />
            <MetadataRow
              label="创建时间"
              value={formatDate(collection?.createTime)}
            />
            <MetadataRow
              label="更新时间"
              value={formatDate(collection?.updateTime)}
            />
          </CardContent>
        </Card>
      </aside>
